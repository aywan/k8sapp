...
import (
	...
	"github.com/aywan/k8sapp/pkg/config"
	"github.com/aywan/k8sapp/pkg/handlers"
	"github.com/aywan/k8sapp/pkg/logger"
	stdlog "github.com/aywan/k8sapp/pkg/logger/standard"
	"github.com/aywan/k8sapp/pkg/router"
	"github.com/aywan/k8sapp/pkg/router/bitroute"
	"github.com/aywan/k8sapp/pkg/version"
)
